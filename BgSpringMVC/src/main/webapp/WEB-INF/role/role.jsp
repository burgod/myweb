...
<script type="text/javascript">
    ...
    function showMenu() {
        ...
        $(".zTreeDemoBackgrounded").bind("mousedown", onBodyDown);
    }
    function hideMenu() {
        $("#menuContent").fadeOut("fast");
        $(".zTreeDemoBackgrounded").unbind("mousedown", onBodyDown);
    }
    function onBodyDown(event) {
        if (!(event.target.id == "citySel" || event.target.id == "menuContent" )) {
            hideMenu();
        }
    }
    $(function() {
