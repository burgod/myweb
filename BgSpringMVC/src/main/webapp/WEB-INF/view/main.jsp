...
<head>
    ...
    <style>
        ...
        .zTreeDemoBackground .ztree li a.level0 {width:200px;height: 20px; text-align: center; display:block; background-color: #0B61A4; border:1px silver solid;}
        .zTreeDemoBackground .ztree li a.level0.cur {background-color: #66A3D2; }
        .zTreeDemoBackground .ztree li a.level0 span {display: block; color: white; padding-top:3px; font-size:12px; font-weight: bold;word-spacing: 2px;}
        .zTreeDemoBackground .ztree li a.level0 span.button { float:right; margin-left: 10px; visibility: visible;display:none;}
        .zTreeDemoBackground .ztree li span.button.switch.level0 {display:none;}
        .wcolor{color: white;}
    </style>
</head>
<body>
